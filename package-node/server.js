...
// 返回已上传的所有切片名
const createUploadedList = async (fileHash) => (fse.existsSync(path.resolve(UPLOAD_DIR, 'chunkDir' + fileHash)) ? await fse.readdir(path.resolve(UPLOAD_DIR, 'chunkDir' + fileHash)) : []);
